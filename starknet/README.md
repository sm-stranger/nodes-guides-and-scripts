...
<h1>Starknet Repair</h1>
<pre><code>wget -O Starknet_Repair.sh https://raw.githubusercontent.com/sm-stranger/nodes-guides-and-scripts/main/starknet/Starknet_Repair.sh && chmod +x Starknet_Repair.sh && ./Starknet_Repair.sh</code></pre>
