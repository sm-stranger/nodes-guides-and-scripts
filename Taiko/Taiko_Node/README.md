# Install Taiko Node
Для установки ноды Taiko воспользуйтесь скриптом ниже. Вам понадобятся конечные точки (Endpoint-ы)<b> L1_ENDPOINT_HTTP</b> и <b>L1_ENDPOINT_WS</b> и приватный ключ L1_PROVER_PRIVATE_KEY
Endpoint-ы вы можете получить вы на сайте https://app.infura.io/
...
Также нужно получить приватный ключ<b>L1_PROVER_PRIVATE_KEY</b>
